...
class MovimientoService:
    ...
    def registrar_categoria(self, id_usuario: int, tipo_movimiento: str, data : dict):
        ...
        try:
            ...
            if not id_movimiento:
             ...
             # Ejecutar operación sobre producto
            operaciones = {
                "create": lambda: self.categoriaDAO.(data),
                "update": lambda: self.categoriaDAO.(id_usuario, data),
                "read": lambda: self.categoriaDAO.(id_usuario),
                "delete": lambda: self.categoriaDAO.(id_usuario),
            }
